// JavaScript Document
		...
		var requestURL = 'https://sodvadiyavidhi.github.io/JavascriptLab4/weird.json';
        ...
        let section = document.querySelector('section');
				...
				img.setAttribute('src', 'https://sodvadiyavidhi.github.io/JavascriptLab4/images/' + weirdthings[i].image);
